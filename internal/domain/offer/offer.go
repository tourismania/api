// Package offer is the offer aggregate: the Offer entity with its
// lifecycle status, the Flight child aggregate, repository contracts
// and the management services enforcing ownership and invariants.
package offer
...
// TitleMaxLength is the maximum allowed length of Offer.Title.
