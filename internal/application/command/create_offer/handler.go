...
// offer.Manager service. Keeping the handler thin preserves DDD: business
...
// the domain user.Finder, not to presentation-layer middleware,
...
// never sees a domain sentinel directly. Creating the offer and
...
// offer.NewFlight before any database write happens, so a malformed
